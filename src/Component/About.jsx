...
const About = () => {
  ...
  <div className="hero-content text-neutral-content text-center">
    <div className="max-w-md">
      <h1 className="mb-5 text-5xl font-bold">About Tour-zone</h1>
...
It's because of you guys that this I'm still doing this. <br />
